...
export class AddComponent implements OnInit {
  ...
  constructor(public datiService: DatiService, public fb: FormBuilder, private router: Router) {
  ...
  ngOnInit(): void {
    ...
    if(typeof history.state.book!=="undefined") {
      this.libro=history.state.book;
    }
    console.log(this.libro);
